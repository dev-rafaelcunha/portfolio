...
<body class="overflow-hidden light">
                ...
                <div class="row row-cards">
                        ...
                        <div class="card bg-dark">
                            <div class="card-body description my-2">
                                <h5 class="card-title"><i
                                        class="fa-brands fa-html5 text-danger d-flex justify-content-center"
                    ...
                    <div class="col-lg-2 my-3">
                        <div class="card bg-dark">
                            <div class="card-body description my-2">
                                <h5 class="card-title"><i
                                        class="fa-brands fa-bootstrap text-danger d-flex justify-content-center"
                                        style="font-size: 69px;"></i></h5>
                    ...
                    <div class="col-lg-2 my-3">
                        <div class="card bg-dark">
                            <div class="card-body description my-2">
                                <h5 class="card-title"><i
                                        class="fa-brands fa-square-js text-danger d-flex justify-content-center"
                                        style="font-size: 69px;"></i></h5>
                    ...
                    <div class="col-lg-2 my-3">
                        <div class="card bg-dark">
                            <div class="card-body description my-2">
                                <h5 class="card-title"><i
                                        class="fa-brands fa-square-github text-danger d-flex justify-content-center"
                                        style="font-size: 69px;"></i></h5>
                    ...
                    <div class="col-lg-2 my-3">
                        <div class="card bg-dark">
                            <div class="card-body description my-2">
                                <h5 class="card-title"><i
                                        class="fa-brands fa-bitbucket text-danger d-flex justify-content-center"
                                        style="font-size: 69px;"></i></h5>
                    ...
                    <div class="col-lg-2 my-3">
                        <div class="card bg-dark">
                            <div class="card-body description my-2">
                                <h5 class="card-title"><i
                                        class="fa-brands fa-trello text-danger d-flex justify-content-center"
                                        style="font-size: 69px;"></i></h5>
